...
bootstrap:
	...
	@echo "Attention!!!!!!:"
	@echo ""
	@echo "Installed new packages. Log out and log in again for changes to take effect."
	@echo ""
	@echo "You could try the below command, but this sometimes doesnt quite work, so logout/login is recommended."
	@echo "source ~/.profile"
	@echo ""
	@echo "After you log out and log in, run 'make' to build the source"
	@echo ""
	@echo "--------------------------------------------------------------------------"
	touch ./bootstrap
