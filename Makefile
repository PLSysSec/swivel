...
run_spec: build_spec install_btbflush
	...
	python spec_stats.py -i sfi-spectre-spec/result --usePercent --filter  \"sfi-spectre/spec/spec_results_sbx_only=wasm_sfi_noblade:sfi_noblade,wasm_cet_noblade:cet_noblade;sfi-spectre-spec/resul/spec_results=wasm_loadlfence:loadlfence,wasm_strawman:strawman,wasm_sfi:sfi,wasm_cet:cet\" -n 8
